...
tar --exclude="./venv*" --exclude="./.git" --exclude='.env' --exclude='.gitignore' --exclude='*.py' --exclude='get-pip.cpython-39.pyc' --exclude='compiler.sh' --exclude='*ocker*' --exclude='*notes*' --exclude='./scripts/__pycache__' -zcvf ../project_morpheus.tgz .
